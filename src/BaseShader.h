...
public:
    ...
    bool load( const char* VertexShaderFile, const char* FragmentShaderFile, const char* GeometryShaderFile = nullptr);
...
protected:
    ...
    GLuint createShaderProgram( const char* VScode, const char* FScode, const char* GScode = nullptr);
